  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['Pablomarttinn/supermarket-push-notification-model','Pablomarttinn/Churn-retention-optimizer'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
    },
